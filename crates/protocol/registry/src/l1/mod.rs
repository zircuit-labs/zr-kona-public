...
use alloy_hardforks::sepolia::{SEPOLIA_BPO1_TIMESTAMP, SEPOLIA_BPO2_TIMESTAMP};
...
// pulled from alloy-hardforks v0.4.3. should be removed with the upstream update pull
...
impl L1Config {
    ...
    pub fn mainnet() -> Self {
        Self(L1ChainConfig {
            ...
            bpo1_time: Some(MAINNET_BPO1_TIMESTAMP),
            bpo2_time: Some(MAINNET_BPO2_TIMESTAMP),
    ...
    /// Parse the zircuit devnet genesis.
    pub fn zircuit_devnet() -> Self {
        Self(L1ChainConfig {
            chain_id: 900u64,
            homestead_block: Some(0),
            dao_fork_block: None,
            ...
            arrow_glacier_block: Some(0),
            gray_glacier_block: Some(0),
            shanghai_time: Some(1760389680),
            cancun_time: Some(1760389680),
            prague_time: Some(1760389680),
            osaka_time: Some(2122603476),
            bpo1_time: None,
            bpo2_time: None,
            bpo3_time: None,
            bpo4_time: None,
    ...
    /// Parse the zircuit sandbox genesis.
    pub fn zircuit_sandbox() -> Self {
        Self(L1ChainConfig {
            chain_id: 3151908u64,
            homestead_block: Some(0),
            dao_fork_block: None,
            ...
            cancun_time: Some(0),
            prague_time: Some(0),
            osaka_time: Some(1760368846),
            bpo1_time: Some(1760369614),
            bpo2_time: None,
            bpo3_time: None,
            bpo4_time: None,
            bpo5_time: None,
            ...
            blob_schedule: BTreeMap::from([
                (
                    alloy_hardforks::EthereumHardfork::Cancun.name().to_string(),
                    BlobParams::cancun(),
                ),
                (
                    alloy_hardforks::EthereumHardfork::Prague.name().to_string(),
                    BlobParams::prague(),
                ),
    ...
    pub fn build_l1_configs() -> HashMap<u64, L1ChainConfig> {
        ...
        l1_configs.insert(900_u64, Self::zircuit_devnet().0);
        l1_configs.insert(3151908_u64, Self::zircuit_sandbox().0);
        l1_configs
    }
}
