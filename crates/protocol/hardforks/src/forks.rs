...
use crate::{Ecotone, Fjord, Interop, Isthmus, Tenrec};
...
impl Hardforks {
    ...
    /// The Isthmus hardfork upgrade transactions.
    pub const TENREC: Tenrec = Tenrec;
...
mod tests {
    ...
    fn test_hardforks() {
        ...
        let tenrec_upgrade_tx = Hardforks::TENREC.txs();
        assert_eq!(tenrec_upgrade_tx.collect::<Vec<_>>().len(), 3);
    }
}
